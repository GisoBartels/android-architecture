...
class StatisticsFragment : Fragment(), StatisticsView {
    ...
    override fun render(viewState: StatisticsView.State) {
        setProgressIndicator(viewState.showProgressIndicator)
        showStatistics(viewState.numberOfIncompleteTasks, viewState.numberOfCompletedTasks)
        if (viewState.showLoadingStatisticsError)
    ...
    private fun showStatistics(numberOfIncompleteTasks: Int, numberOfCompletedTasks: Int) {
    ...
    private fun showLoadingStatisticsError() {
